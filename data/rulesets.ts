...
export const Rulesets: {[k: string]: FormatData} = {
	...
	standardnatdex: {
		...
		ruleset: [
			'Obtainable', '+Unobtainable', '+Past', 'Sketch Post-Gen 7 Moves', 'Team Preview', 'Nickname Clause', 'HP Percentage Mod', 'Cancel Mod', 'Endless Battle Clause', 'Terastal Clause', 'Z-Move Clause',
		],
		onValidateSet(set) {
			const species = this.dex.species.get(set.species);
