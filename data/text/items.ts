export const ItemsText: {[k: string]: ItemText} = {
	...
	drakurite: {
		name: "Drakurite",
		desc: "If held by a Drakura, this item allows it to Mega Evolve in battle.",
	},
	withordite: {
		name: "Withordite",
	...
	atlascrossite: {
		name: "Atlascrossite",
		desc: "If held by a Atlascross, this item allows it to Mega Evolve in battle.",
	},
	taurosite: {
		name: "Taurosite",
	...
	ghoulizardite: {
		name: "Ghoulizardite",
		desc: "If held by a Ghoulizard, this item allows it to Mega Evolve in battle.",
	},
	pumpkasaurite: {
		name: "Pumpkasaurite",
		desc: "If held by a Pumpkasaur, this item allows it to Mega Evolve in battle.",
	},
	spectoisite: {
		name: "Spectoisite",
		desc: "If held by a Spectoise, this item allows it to Mega Evolve in battle.",
	},
	crystalixite: {
		name: "Crystalixite",
		desc: "If held by a Crystalix, this item allows it to Mega Evolve in battle.",
	},
	zapoleonite: {
		name: "Zapoleonite",
		desc: "If held by a Zapoleon, this item allows it to Mega Evolve in battle.",
	},
	geyseruptite: {
		name: "Geyseruptite",
		desc: "If held by a Geyserupt, this item allows it to Mega Evolve in battle.",
	},
	frostikenite: {
		name: "Frostikenite",
	...
	excadrite: {
		name: "Excadrite",
		desc: "If held by a Excadrill, this item allows it to Mega Evolve in battle.",
	},
	feraligite: {
		name: "Feraligite",
