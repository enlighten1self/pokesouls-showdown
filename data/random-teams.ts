import {MoveCounter, TeamData, RandomGen8Teams} from './mods/gen8/random-teams';
...
export class RandomTeams extends RandomGen8Teams {
	...
	randomFactorySets: {[format: string]: {[species: string]: BattleFactorySpecies}} = require('./mods/gen7/factory-sets.json');
