...
describe('Dex data', function () {
	it('should have valid Pokedex entries', function () {
		...
		for (const pokemonid in Pokedex) {
			...
			const battleOnly = ['Mega', 'Mega-X', 'Mega-Y', 'Primal',"Paldea-Aqua-Mega","Paldea-Blaze-Mega","Paldea-Combat-Mega"].includes(entry.forme) ? entry.baseSpecies : entry.battleOnly;
