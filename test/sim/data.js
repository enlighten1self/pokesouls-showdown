...
describe('Dex data', function () {
	it('should have valid Pokedex entries', function () {
		...
		for (const pokemonid in Pokedex) {
			...
			const battleOnly = ['Mega', 'Mega-X', 'Mega-Y', 'Mega-Z', 'Primal',"Paldea-Aqua-Mega","Paldea-Blaze-Mega","Paldea-Combat-Mega"].includes(entry.forme) ? entry.baseSpecies : entry.battleOnly;
