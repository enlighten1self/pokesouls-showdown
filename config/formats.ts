...
export const Formats: FormatList = [
	...
	},
	{
		...
		banlist: [
			...
			'Darmanitan-Galar', 'Delphox-Mega', 'Deoxys-Base', 'Deoxys-Attack', 'Dialga-Base', 'Dialga-Origin', 'Eternatus', 'Flutter Mane', 'Forrogue-Mega', 'Frostiken-Mega', 'Giratina-Base', 
			'Giratina-Origin', 'Greninja-Mega', 'Groudon-Base', 'Groudon-Primal', 'Ho-Oh', 'Kangaskhan-Mega', 'Kyogre-Base', 'Kyogre-Primal', 'Kyurem-Black', 'Kyurem-White', 'Lopunny-Mega', 'Lucario-Mega', 
			'Lugia', 'Lunala', 'Marshadow', 'Mewtwo-Base', 'Mewtwo-Mega-X', 'Mewtwo-Mega-Y', 'Naganadel', 'Necrozma-Dawn-Wings', 'Necrozma-Dusk-Mane', 'Necrozma-Ultra', 'Palkia-Base', 'Palkia-Origin', 
			'Pheromosa', 'Rayquaza', 'Reshiram', 'Salamence-Mega', 'Shaymin-Sky', 'Solgaleo', 'Spectrier', 'Tempervian-Mega', 'Ursaluna-Bloodmoon', 'Urshifu-Base', 'Xerneas', 'Yveltal', 'Zacian-Base', 
			'Zacian-Crowned', 'Zamazenta-Crowned', 'Zekrom', 'Zygarde-Base', 'Power Construct', 'Fishious Rend', 'Bolt Beak', 'Speed Boost', 'Shadow Tag', 'Arena Trap', 'Assist', 'Quick Claw', 'Razor Fang', 
			'Bright Powder', 'King\'s Rock', 'Moody', 'Baton Pass', 'Last Respects', 'Revival Blessing', 'Shed Tail', 'Atlascross-Mega', 'Zygarde-Complete', 'Rage Fist', 'Contrary', 'Scovillain-Mega', 
			'Beads of Ruin', 'Triage', 'Sheer Force', 
		],
		restricted: [
			'Dragapult', 'Genesect', 'Iron Bundle', 'Magearna', 'Ogerpon-Hearthflame', 'Abyssal Void', 'Boomkeldurr', 'Darkrai', 'Deoxys-Speed', 'Diancie-Mega', 'Excadrill-Mega',
			...
			'Electric Surge', 'Psychic Surge', 'Poison Heal', 'Basculegion-Base', 'Basculegion-F', 'Beedrill-Mega', 'Eeveeon', 'Porygon-Z', 'Glimmora-Mega', 'Toxic Debris', 'Corrosion', 'Fur Coat',
