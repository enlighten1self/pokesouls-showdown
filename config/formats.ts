...
export const Formats: FormatList = [
	...
	},
	{
		...
		restricted: [
			'Dragapult', 'Genesect', 'Iron Bundle', 'Magearna', 'Ogerpon-Hearthflame', 'Abyssal Void', 'Boomkeldurr', 'Darkrai', 'Deoxys-Speed', 'Diancie-Mega', 'Excadrill-Mega', 'Garchomp', 'Melmetal', 'Ogerpon-Wellspring', 
			...
			'Corrosion', 'Fur Coat', 'Ice Scales', 'Volcarona', 'Withorde-Mega', 'Zamazenta', 'Ghoulizard-Mega', 'Atlascross', 'Mawile-Mega', 'Medicham-Mega', 'Huge Power', 'Pure Power', 'Extreme Speed', 'Boomburst', 
			'Dragonite', 'Smeargle', 'Mew', 'Neutralizing Gas', 'Palafin', 'Ultigigas', 'Chrono Venom', 'Population Bomb', 'Cloyster', 'Shell Smash', 'Fillet Away', 'Victini', 'Power Trip', 'Stored Power', 
			...
			'Urshifu', 'Gear Grind', 'Gigaton Hammer', 'Floette-Eternal', 'No Retreat', 'Titanium Delta', 'Electro Shot', 'Walking Wake', 'Sulphuric Downpour', 'Psycho Boost', 'Shift Gear', 'Tail Glow', 'Take Heart', 
			'Xurkitree', 'Torch Song', 'Triple Arrows', 'Ditto', 'Celebrate', 'Happy Hour', 'Conversion', 'Tricky Reception', 'Hoopa-Unbound', 'Blacephalon', 'Comatose', 'Hawlucha-Mega', 'Pidgeot-Mega', 
			...
			'Simple', 'Zapoleon-Mega', 'Swift Swim', 'Chlorophyll', 'Sand Rush', 'Slush Rush', 'Bulking Blade', 'Ursaluna-Bloodmoon', 'Zygarde', 'Caimanrago', 'Kyurem', 'Triage', 'Kommo-o', 
			'Celesteela', 'Great Tusk', 'Elysian Dance', 'Adaptability', 'Good as Gold', 'Klinklang', 'Haxorus', 'Heal Order', 'Serene Grace', 'Tapu Lele', 'Mega Sol', 'Armored Poncho',
			'Metagross-Mega', 'Zeranheit', 'Tapu Koko', 'Manaphy', 'Barbaracle-Mega', 'Lopunny-Mega', 'Delphox-Mega', 'Greninja-Mega',
		],
	},
	//{
