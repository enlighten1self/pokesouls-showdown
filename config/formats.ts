...
export const Formats: FormatList = [
	...
	},
	{
		...
		banlist: [
			...
			'Fur Coat', 'Ice Scales', 'Speed Boost', 'Neutralizing Gas', 'Light Ball',
		],
		restricted: [
	...
	},
	{
		...
		restricted: [
			'Dragapult', 'Genesect', 'Iron Bundle', 'Magearna', 'Ogerpon-Hearthflame', 'Abyssal Void', 'Boomkeldurr', 'Darkrai', 'Deoxys-Speed', 'Diancie', 'Excadrill', 'Garchomp', 'Melmetal', 
			'Metagross', 'Ogerpon-Wellspring', 'Quantum Syphon', 'Roaring Moon', 'Spectoise', 'Starmie', 'Rising Voltage', 'Expanding Force', 'Electric Surge', 'Psychic Surge', 'Poison Heal', 
			'Basculegion', 'Beedrill', 'Eeveeon', 'Porygon-Z', 'Glimmora', 'Toxic Debris', 'Corrosion', 'Fur Coat', 'Ice Scales', 'Volcarona', 'Withorde', 'Zamazenta-Base', 'Wyrmperior', 
			'Ghoulizard', 'Aggron', 'Atlascross-Base', 'Azumarill', 'Mawile', 'Medicham', 'Huge Power', 'Pure Power', 'Extreme Speed', 'Boomburst', 'Dragonite', 'Zygarde-10%', 'Smeargle', 
			'Mew', 'Mountain Gale', 'Neutralizing Gas', 'Palafin', 'Ultigigas', 'Chrono Venom', 'Population Bomb', 'Tidy Up', 'Cloyster', 'Shell Smash', 'Fillet Away', 'Victini', 'Power Trip', 'Stored Power', 
			'Mystical Power', 'Ceaseless Edge', 'Stone Axe', 'Stainless Slash', 'Regenerator', 'Glare', 'Quiver Dance', 'Victory Dance', 'Eruption', 'Water Spout', 'Dragon Energy', 'Dragon\'s Maw', 'Regieleki', 
			'Shedinja', 'Flower Trick', 'Urshifu-Rapid-Strike', 'Gear Grind', 'Gigaton Hammer', 'Floette-Eternal', 'No Retreat', 'Titanium Delta', 'Archaludon', 'Walking Wake', 'Sulphuric Downpour', 'Psycho Boost', 
			'Pumpkin Mash', 'Revelation Dance', 'Shift Gear', 'Spirit Shackle', 'Soul Anchor', 'Tail Glow', 'Take Heart', 'Xurkitree', 'Kartana', 'Torch Song', 'Tremor Turn', 'Triple Arrows', 'Aura Wheel', 'Ditto', 
			'Celebrate', 'Happy Hour', 'Conversion', 'Tricky Reception', 'Altitude', 'Hoopa-Unbound', 'Latios', 'Charizard', 'Blacephalon', 'Zapoleon', 'Typhtesla', 'Sceptile', 'Comatose',
			'Thundurus-Therian', 'Meganium', 'Froslass', 'Hawlucha', 'Pidgeot', 'Electrode-Hisui', 'Reuniclus', 'Alakazam', 'Magic Guard', 'Beast Boost', 'Anger Shell', 'Libero', 'Protean', 
			'Protomorphosis', 'Protosynthesis', 'Quark Drive', 'Neuro Drive', 'Toxic Chain', 'Sharpness', 'Vessel of Ruin', 'Tablets of Ruin', 'Weavile', 'Chien-Pao', 'Ogerpon-Cornerstone', 'Storm Throw', 'Steelix', 
			'Iron Valiant', 'Iron Moth', 'Drought', 'Drizzle', 'Sand Stream', 'Snow Warning', 'Magnet Pull', 'Revival Blessing', 'Solgaleo', 'Reshiram', 'Regigigas', 'Slaking', 'Clangorous Soul', 'Terapagos',
		],
	},
	//{
