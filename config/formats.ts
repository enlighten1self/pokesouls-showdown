...
export const Formats: FormatList = [
	...
	},
	{
		...
		restricted: [
			...
			'Metagross-Mega', 'Ogerpon-Wellspring', 'Quantum Syphon', 'Roaring Moon', 'Spectoise-Mega', 'Starmie-Mega', 'Rising Voltage', 'Expanding Force', 'Electric Surge', 'Psychic Surge', 'Poison Heal', 
			'Basculegion', 'Beedrill-Mega', 'Eeveeon', 'Porygon-Z', 'Glimmora-Mega', 'Toxic Debris', 'Corrosion', 'Fur Coat', 'Ice Scales', 'Volcarona', 'Withorde-Mega', 'Zamazenta-Base', 'Wyrmperior', 
			'Ghoulizard-Mega', 'Aggron-Mega', 'Atlascross-Base', 'Azumarill', 'Mawile-Mega', 'Medicham-Mega', 'Huge Power', 'Pure Power', 'Extreme Speed', 'Boomburst', 'Dragonite', 'Zygarde-10%', 'Smeargle', 
			...
			'Celebrate', 'Happy Hour', 'Conversion', 'Tricky Reception', 'Altitude', 'Hoopa-Unbound', 'Latios-Mega', 'Charizard-Mega-Y', 'Blacephalon', 'Zapoleon-Mega', 'Typhtesla-Mega', 'Sceptile-Mega', 'Comatose',
			'Thundurus-Therian', 'Meganium-Mega', 'Froslass-Mega', 'Hawlucha-Mega', 'Pidgeot-Mega', 'Electrode-Hisui', 'Reuniclus', 'Alakazam', 'Magic Guard', 'Beast Boost', 'Anger Shell', 'Libero', 'Protean', 
			'Protomorphosis', 'Protosynthesis', 'Quark Drive', 'Neuro Drive', 'Toxic Chain', 'Sharpness', 'Vessel of Ruin', 'Tablets of Ruin', 'Weavile', 'Chien-Pao', 'Ogerpon-Cornerstone', 'Storm Throw', 'Steelix-Mega', 
